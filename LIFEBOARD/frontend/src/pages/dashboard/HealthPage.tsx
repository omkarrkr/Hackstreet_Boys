        ...
        <div className="mb-8">
          <div className="flex justify-between items-start mb-4">
            ...
            <div className="flex gap-3">
              <button
                onClick={() => alert('AI Analysis - Coming Soon!\n\nThis feature will analyze your health trends, workout effectiveness, and provide personalized fitness recommendations.')}
                className="px-5 py-2.5 bg-slate-700 hover:bg-slate-600 text-white rounded-lg transition-colors flex items-center gap-2"
              >
